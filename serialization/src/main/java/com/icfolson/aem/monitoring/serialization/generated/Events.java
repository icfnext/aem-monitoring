...
public final class Events extends Table {
  ...
  public static Events getRootAsEvents(ByteBuffer _bb, Events obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public Events __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; return this; }
  ...
  public static void startEvents(FlatBufferBuilder builder) { builder.startObject(1); }
  ...
  public static void finishEventsBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
}
