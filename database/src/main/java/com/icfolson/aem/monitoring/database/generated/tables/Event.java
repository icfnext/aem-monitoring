...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = 1937059033;
     ...
     */
    public final TableField<EventRecord, Long> EVENT_ID = createField("EVENT_ID", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR MONITORING.SYSTEM_SEQUENCE_4E78CEB2_F365_4182_A63E_AFA6ECDC68F2)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<EventRecord, Short> SYSTEM_ID = createField("SYSTEM_ID", org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");
