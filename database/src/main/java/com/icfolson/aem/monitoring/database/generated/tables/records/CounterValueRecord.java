...
public class CounterValueRecord extends TableRecordImpl<CounterValueRecord> implements Record4<Short, UUID, Long, Integer> {

    private static final long serialVersionUID = 108898868;
     ...
     */
    @Override
    public Row4<Short, UUID, Long, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row4<Short, UUID, Long, Integer> valuesRow() {
     ...
     */
    @Override
    public CounterValueRecord values(Short value1, UUID value2, Long value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CounterValueRecord(Short counterId, UUID systemId, Long time, Integer incrementValue) {
        super(CounterValue.COUNTER_VALUE);
