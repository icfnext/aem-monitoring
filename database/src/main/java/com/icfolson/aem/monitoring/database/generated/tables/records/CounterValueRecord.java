...
public class CounterValueRecord extends TableRecordImpl<CounterValueRecord> implements Record4<Short, String, Long, Integer> {

    private static final long serialVersionUID = -1573158451;
     ...
     */
    @Override
    public Row4<Short, String, Long, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row4<Short, String, Long, Integer> valuesRow() {
     ...
     */
    @Override
    public CounterValueRecord value2(String value) {
        setSystemId(value);
        return this;
    }
     ...
     */
    @Override
    public CounterValueRecord values(Short value1, String value2, Long value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CounterValueRecord(Short counterId, String systemId, Long time, Integer incrementValue) {
        super(CounterValue.COUNTER_VALUE);
