...
public class MetricValueRecord extends TableRecordImpl<MetricValueRecord> implements Record4<Long, UUID, Long, Float> {

    private static final long serialVersionUID = 578999848;
     ...
     */
    @Override
    public Row4<Long, UUID, Long, Float> fieldsRow() {
     ...
     */
    @Override
    public Row4<Long, UUID, Long, Float> valuesRow() {
     ...
     */
    @Override
    public MetricValueRecord values(Long value1, UUID value2, Long value3, Float value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MetricValueRecord(Long metricId, UUID systemId, Long time, Float metricValue) {
        super(MetricValue.METRIC_VALUE);
