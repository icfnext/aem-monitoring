...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements Record4<Long, Short, UUID, Long> {

    private static final long serialVersionUID = -430921757;
     ...
     */
    @Override
    public Row4<Long, Short, UUID, Long> fieldsRow() {
     ...
     */
    @Override
    public Row4<Long, Short, UUID, Long> valuesRow() {
     ...
     */
    @Override
    public EventRecord value3(UUID value) {
        setSystemId(value);
        return this;
    }
     ...
     */
    @Override
    public EventRecord values(Long value1, Short value2, UUID value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Long eventId, Short eventTypeId, UUID systemId, Long time) {
        super(Event.EVENT);
