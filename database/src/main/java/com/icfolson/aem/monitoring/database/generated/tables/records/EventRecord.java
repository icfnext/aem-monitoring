...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements Record4<Long, Short, String, Long> {

    private static final long serialVersionUID = 1989054400;
     ...
     */
    @Override
    public EventRecord values(Long value1, Short value2, String value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Long eventId, Short eventTypeId, String systemId, Long time) {
        super(Event.EVENT);
