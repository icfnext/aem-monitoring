...
public class SystemRecord extends UpdatableRecordImpl<SystemRecord> implements Record1<UUID> {

    private static final long serialVersionUID = 690043434;
     ...
     */
    @Override
    public SystemRecord values(UUID value1) {
        value1(value1);
        return this;
    }
     ...
     */
    public SystemRecord(UUID systemId) {
        super(System.SYSTEM);
