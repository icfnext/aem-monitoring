  ...
  ALTER TABLE MONITORING.EVENT_TYPE ADD CONSTRAINT UNIQUE_EVENT_TYPE_NAME UNIQUE (EVENT_NAME);
  ...
  ALTER TABLE MONITORING.COUNTER ADD CONSTRAINT UNIQUE_COUNTER_NAME UNIQUE (COUNTER_NAME);
  ...
  ALTER TABLE MONITORING.METRIC ADD CONSTRAINT UNIQUE_METRIC_NAME UNIQUE (METRIC_NAME);
