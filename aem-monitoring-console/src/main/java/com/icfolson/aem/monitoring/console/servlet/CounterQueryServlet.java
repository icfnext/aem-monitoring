...
@SlingServlet(paths = "/bin/monitoring/counters", extensions = "json", methods = "GET")
public class CounterQueryServlet extends SlingAllMethodsServlet {
    ...
    @Reference
    private CounterQueryService service;
    ...
    protected void doGet(final SlingHttpServletRequest request, final SlingHttpServletResponse response)
        ...
        final CounterQuery query = new CounterQuery();
